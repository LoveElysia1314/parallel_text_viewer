...
class TestPatternPathResolver:
    ...
    def test_expand_pattern_simple(self, tmp_path):
        ...
        results = resolver.expand_pattern(
            "vol_{volume}/{lang}/{chapter}.md", volume="001", lang="cn", chapter="118359"
        )
    ...
    def test_expand_pattern_with_glob(self, tmp_path):
        ...
        # 展开 pattern（包含 glob）
        results = resolver.expand_pattern(
            "images/{book_id}/vol_{volume}/{chapter}_*.jpg", volume="001", chapter="118359"
        )
    ...
    def test_expand_pattern_auto_book_id(self, tmp_path):
        ...
        # 不显式传递 book_id，应自动使用
        results = resolver.expand_pattern("images/{book_id}/test.jpg")
    ...
    def test_expand_pattern_nonexistent(self, tmp_path):
        ...
        results = resolver.expand_pattern(
            "vol_{volume}/cn/{chapter}.md", volume="001", chapter="nonexistent"
        )
    ...
    def test_expand_pattern_glob_no_match(self, tmp_path):
        ...
        results = resolver.expand_pattern(
            "images/{book_id}/vol_{volume}/nonexistent_*.jpg", volume="001"
        )
...
class TestBuildOptions:
    ...
    def test_build_options_path_conversion(self):
        ...
        options = BuildOptions(data_root="data", output_dir="output", book_id="2930")
...
class TestBuildFromDataIntegration:
            ...
            "volumes": [
                {
                    ...
                    "chapters": [
                        {"chapter_name": "Chapter 1", "url": "https://example.com/2930/118359.htm"}
                    ],
                }
            ]
        }
    ...
    def test_build_from_data_missing_working_dir(self, tmp_path):
        ...
        # 这是向后兼容的行为
        result = build_from_data(
            BuildOptions(data_root=data_root, output_dir=output_dir, book_id="nonexistent")
        )
    ...
    def test_build_from_data_truly_missing_dir(self, tmp_path):
        ...
        result = build_from_data(
            BuildOptions(data_root=data_root, output_dir=output_dir, book_id="2930")
        )
